...
$CheckoutRequestID = 'ws_CO_14092024172412675113421691';
...
$massage = "Unknown error occurred"; // Default message if no ResultCode matches
...
if (isset($data_to->ResultCode)) {
  ...
  if ($ResultCode == '1037') {
    ...
    $massage = "0 The transaction was successful";
  }
}
echo $massage;
